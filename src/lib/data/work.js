export default [
  {
    ...
    description: "ComSales Management is a case commission management web application that enhances the business operation of a real estate company.",
    tools: [
      "SASS",
      "REACT",
      "ExpressJS",
    ...
    github_link: "https://github.com/vinc3w/ComSales-Management",
    features: [
      {
      ...
      },
      {
        ...
        values: [
          "Automatically get earning, bonus, etc",
        ],
      },
    ],
  },
  {
    ...
    github_link: "https://github.com/vinc3w/JobHub",
    features: [
      {
        label: "Authentication",
        values: [
      ...
      },
      {
        label: "Admin System",
        values: [
          "Moderation over user's portfolio",
        ],
      },
      {
        label: "Notification System",
        values: [
          "Get Notified when your portfolio has been changed by an admin",
        ],
      },
    ],
  },
